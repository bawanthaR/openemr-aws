...
<body class="min-vw-100">
    ...
    <div id="mainBox" <?php echo $disp_mainBox ?> >
        ...
        <img src="Apium_helth_logo.png" height="42" width="42" >
    ...
    <!-- Footer -->
<footer class="page-footer font-small blue" style="background-color:#3383FF;">

  <!-- Copyright -->
  <div class="footer-copyright text-center py-3" style="color:#99D7E8;">© 2020 Copyright:
    <a href="https://apium.io/" style="color:#FFFFFF;">Apium.io</a>
  </div>
  <!-- Copyright -->
